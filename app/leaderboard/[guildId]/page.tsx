    ...
    return (
        <div className="w-full">
            ...
            <div className="md:flex">
                ...
                <table itemScope itemType="https://schema.org/ItemList" className="md:w-3/4 md:mr-6">
                                ...
                                (members || []).sort((a, b) => (b?.activity?.[searchParams.type as Types] ?? 0) - (a?.activity?.[searchParams.type as Types] ?? 0)).map((member) =>
                                    ...
                                    >
                                        ...
                                        <td>
                                            ...
                                            <div className="text-sm dark:text-neutral-300 text-neutral-700" itemProp="name">@{member.username}</div>
                                        </td>

                                        <td className="ml-auto flex text-xl font-medium dark:text-neutral-200 text-neutral-800">
                    ...
                    <tfoot className="flex h-10 w-full mt-5">
