        ...
        <div className="flex flex-col w-full">
            ...
            {guilds.map((guild) => (
                <div className="bg-wamellow py-4 px-5 mb-4 flex items-center rounded-lg w-full drop-shadow-md" key={guild.id}>
                    <Image src={guild.icon ? `https://cdn.discordapp.com/icons/${guild.id}/${guild.icon}.webp?size=64` : "https://cdn.waya.one/r/discord.png"} width={56} height={56} alt="Server" className="rounded-lg h-16 w-16" />
