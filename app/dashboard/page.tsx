        ...
        <div className="flex flex-col w-full">
            ...
            {guilds.map((guild) => (
                <div className="dark:bg-wamellow bg-wamellow-100 py-4 px-5 mb-4 flex items-center rounded-lg w-full drop-shadow-md" key={guild.id}>
                    <Image src={guild.icon ? `https://cdn.discordapp.com/icons/${guild.id}/${guild.icon}.${guild.icon.startsWith("a_") && !web.reduceMotions ? "gif" : "webp"}?size=64` : "/discord.png"} width={64} height={64} alt="Server" className="rounded-lg h-16 w-16" />
